...
namespace Jukebox.Services
{
    public class ThemeService
    {
        ...
        public static void ApplyFontSizes(double globalFontSize, double dataGridFontSize)
        {
            ...
            app.Resources["ComboBoxMinHeight"] = globalFontSize + 10;
            app.Resources["NumericUpDownMinHeight"] = globalFontSize + 10;
            app.Resources["ButtonSpinnerButtonHeight"] = Math.Round((globalFontSize + 10) / 2);
        ...
        public static void ApplyThemeVariant(int themeIndex)
        {
            ...
            var uri = new Uri($"avares://Jukebox/Assets/Icons/{iconName}");
