...
public partial class JukeboxVisualizerViewModel
{
    ...
    private async Task AddToFavorites()
    {
        ...
        var favFolder = GetFavoritesFolder();
    ...
    private void UpdateTreeForAddedFavorite(string destPath)
    {
        ...
        if (favFolder == null)
        {
            var favPath = GetFavoritesFolder();
    ...
    private async Task RenameVisualizerAsync()
    {
        ...
        var newName = await _dialogService.ShowRenameAsync(currentName);
    ...
    private string GetFavoritesFolder()
    {
        return ActiveVisualizer?.FavoritesDirectory
            ?? Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Visualizer", "Favorites");
    }
}
